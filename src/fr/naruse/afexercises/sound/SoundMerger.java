    ...
    public SoundMerger() throws Exception {
        ...
        for (int i = 1; i < 101; i++) {
            ...
            AudioInputStream[] clips = new AudioInputStream[]{
                    ...
                    AudioSystem.getAudioInputStream(Main.class.getClassLoader().getResourceAsStream("resources/sounds/1.wav"))
                    ,AudioSystem.getAudioInputStream(Main.class.getClassLoader().getResourceAsStream("resources/sounds/2.wav"))
                    ,AudioSystem.getAudioInputStream(Main.class.getClassLoader().getResourceAsStream("resources/sounds/3.wav"))
                    ,AudioSystem.getAudioInputStream(Main.class.getClassLoader().getResourceAsStream("resources/sounds/4.wav"))
                    ,AudioSystem.getAudioInputStream(Main.class.getClassLoader().getResourceAsStream("resources/sounds/5.wav"))
                    ,AudioSystem.getAudioInputStream(Main.class.getClassLoader().getResourceAsStream("resources/sounds/6.wav"))
                    ,AudioSystem.getAudioInputStream(Main.class.getClassLoader().getResourceAsStream("resources/sounds/7.wav"))
                    ,AudioSystem.getAudioInputStream(Main.class.getClassLoader().getResourceAsStream("resources/sounds/8.wav"))
                    ,AudioSystem.getAudioInputStream(Main.class.getClassLoader().getResourceAsStream("resources/sounds/9.wav"))};
            AudioInputStream beep = AudioSystem.getAudioInputStream(Main.class.getClassLoader().getResourceAsStream("resources/sounds/beep.wav"));
            AudioInputStream zero = AudioSystem.getAudioInputStream(Main.class.getClassLoader().getResourceAsStream("resources/sounds/0.wav"));
            ...
            for (int j = 0; j < 36; j++) {
                ...
                result += o+1;
                clips[o] = AudioSystem.getAudioInputStream(Main.class.getClassLoader().getResourceAsStream("resources/sounds/"+(o+1)+".wav"));
            }
            ...
            for (int k = 0; k < resultString.length(); k++) {
                ...
                if(c == '0'){
                    ...
                    AudioInputStream strem = AudioSystem.getAudioInputStream(Main.class.getClassLoader().getResourceAsStream("resources/sounds/"+Integer.valueOf(c+"")+".wav"));
